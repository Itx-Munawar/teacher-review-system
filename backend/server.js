...
app.get('/api/teachers/:id/summary', async (req, res) => {
    try {
        ...
        const PHRASES = [
            ...
            ['achy teacher', 1, 'teaching'],
            ['ache teacher', 1, 'teaching'],
            ['achha teacher', 1, 'teaching'],
            ['parhata hai', 1, 'teaching'],
            ['padhata hai', 1, 'teaching'],
            ['padhati hai', 1, 'teaching'],
            ['padhati h', 1, 'teaching'],
            ['padhata h', 1, 'teaching'],
            ['pyara banda', 1, 'attitude'],
            ['pyara insaan', 1, 'attitude'],
            ['best insaan', 1, 'attitude'],
